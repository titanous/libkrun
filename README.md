...
* A working [musl](https://musl.libc.org/) toolchain target (```x86_64-unknown-linux-musl```), as the [init](init/src/main.rs) binary is statically linked
* patchelf
...
The [init](init/src/main.rs) binary is cross-compiled to `x86_64-unknown-linux-musl` using Rust.
