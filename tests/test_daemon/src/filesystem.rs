...
impl SyntheticFs {
    ...
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        for _ in 0..num_inodes {
            // Read nodeid
            if offset + 8 > buf.len() {
                return Err(std::io::Error::new(std::io::ErrorKind::InvalidData, "truncated nodeid"));
            }
            ...
            // Read name_len
            if offset + 4 > buf.len() {
                return Err(std::io::Error::new(std::io::ErrorKind::InvalidData, "truncated name_len"));
            }
            ...
            if offset + name_len > buf.len() {
                return Err(std::io::Error::new(std::io::ErrorKind::InvalidData, "truncated name"));
            }
            ...
            // Read mode
            if offset + 4 > buf.len() {
                return Err(std::io::Error::new(std::io::ErrorKind::InvalidData, "truncated mode"));
            }
            ...
            // Read size
            if offset + 8 > buf.len() {
                return Err(std::io::Error::new(std::io::ErrorKind::InvalidData, "truncated size"));
            }
            ...
            // Read nlink
            if offset + 4 > buf.len() {
                return Err(std::io::Error::new(std::io::ErrorKind::InvalidData, "truncated nlink"));
            }
            ...
            // Read data_len
            if offset + 4 > buf.len() {
                return Err(std::io::Error::new(std::io::ErrorKind::InvalidData, "truncated data_len"));
            }
            ...
            if offset + data_len > buf.len() {
                return Err(std::io::Error::new(std::io::ErrorKind::InvalidData, "truncated data"));
            }
